					...
					<tbody>
						...
						<tr>
							<td style="text-align: center;">Rp.
								<?= number_format($this->Transaksi_model->pemasukan_hari_ini()); ?></td>
							<td style="text-align: center;">Rp.
								<?= number_format($this->Transaksi_model->pemasukan_bulan_ini()); ?></td>
							<td style="text-align: center;">Rp.
								<?= number_format($this->Transaksi_model->pemasukan()); ?></td>
						</tr>
					</tbody>
				</table>
			</div>
			<div class="col-xs-12">
				<table class="table table-striped">
					<tbody>
						...
						<tr>
							<td style="text-align: center;">Rp.
								<?= number_format($this->Transaksi_model->pengeluaran_hari_ini()); ?></td>
							<td style="text-align: center;">Rp.
								<?= number_format($this->Transaksi_model->pengeluaran_bulan_ini()); ?></td>
							<td style="text-align: center;">Rp.
								<?= number_format($this->Transaksi_model->pengeluaran()); ?></td>
